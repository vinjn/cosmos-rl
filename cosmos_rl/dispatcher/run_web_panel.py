...
async def get_status():
    return {
        ...
        "policy_replicas": _serialize_replicas(controller.policy_status_manager.policy_replicas),
        "rollout_replicas": _serialize_replicas(controller.rollout_status_manager.rollout_replicas),
    }
